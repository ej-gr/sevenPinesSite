              ...
              {solutions.map((solution, index) => (
                ...
                >
                  ...
                  <div className="relative flex-1 flex flex-col">
                    <h3 className="text-xl font-bold leading-tight mb-3 group-hover:text-pine-gold transition-colors duration-[250ms]">
                      {solution.title}
                    </h3>
                    <p className="text-white/80 group-hover:text-white transition-all duration-[250ms]">
