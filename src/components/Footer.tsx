        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-12 mb-12">
          <div>
            ...
            <div className="flex gap-4">
              <a href="https://www.facebook.com/sevenpinesdesign" target="_blank" rel="noopener noreferrer" className="w-10 h-10 bg-pine-green/20 hover:bg-pine-gold rounded-lg flex items-center justify-center transition-colors" aria-label="Facebook">
          ...
          <div>
            ...
            <ul className="space-y-4">
              ...
              <li className="flex items-start gap-3">
                <MapPin className="w-5 h-5 text-pine-gold flex-shrink-0 mt-0.5" />
                <span>Remote Studio<br />Serving Clients Worldwide</span>
              </li>
            </ul>
          </div>
        </div>
