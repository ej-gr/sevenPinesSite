            ...
            <div className="bg-white p-8 rounded-xl shadow-lg border border-pine-green/20">
              ...
              <div className="mt-8 pt-8 border-t border-pine-green/10">
                <button
                  ...
                  className="block w-full px-6 py-4 bg-transparent border-2 border-pine-green hover:bg-pine-green text-pine-green hover:text-white font-semibold rounded-lg transition-all duration-300 text-center"
                >
                  Book a Consultation
                </button>
              </div>
