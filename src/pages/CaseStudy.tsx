...
export default function CaseStudy() {
  ...
  useEffect(() => {
    async function fetchCaseStudy() {
      // If Supabase is not configured, skip fetching
      if (!supabase) {
        setLoading(false);
        return;
      }
    ...
    return (
      <div className="pt-20 min-h-screen bg-white flex items-center justify-center">
        <div className="text-center max-w-md">
          <h1 className="text-3xl font-bold text-pine-navy mb-4">
            {!supabase ? 'Case Studies Coming Soon' : 'Case Study Not Found'}
          </h1>
          <p className="text-pine-navy/70 mb-8">
            {!supabase 
              ? "We're currently updating our case studies. Check back soon to see our amazing client success stories!"
