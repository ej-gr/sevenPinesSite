      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-20">
        <div className="text-center mb-16">
          ...
          <h1 className="text-5xl lg:text-6xl font-bold text-pine-navy mb-6">
            Real Businesses, <span className="text-pine-green">Real Results</span>
          </h1>
          <p className="text-xl text-pine-navy/70 max-w-3xl mx-auto leading-relaxed">
            From local service providers to professional firms—see how our 7-day builds drive growth for small businesses across Connecticut and beyond.
          </p>
        </div>
